...
set CLASSPATH=%APP_HOME%\lib\custom-runtime.jar

@rem Execute advanced-02-custom-runtime
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ADVANCED_02_CUSTOM_RUNTIME_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ADVANCED_02_CUSTOM_RUNTIME_EXIT_CONSOLE%" exit 1
exit /b 1
